...
export class AddUserIndexes1770863061930 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_204e9b624861ff4a5b26819210" ON "users" ("createdAt") `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_2a32f641edba1d0f973c19cc94" ON "users" ("deletedAt") `);
    }
