    ...
    return (
        <div className="flex flex-col gap-6 h-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-full">
                ...
                {user.role === "admin" && (
                    <>
                        <Card className="md:col-span-4 border-none shadow-sm bg-gray-50/50 hover:bg-gray-50 transition-colors rounded-2xl">
                            <CardHeader className="flex flex-row items-center justify-between pb-2">
                                <CardTitle className="text-sm font-medium text-zinc-500">Total Usuarios</CardTitle>
                        ...
                        <Card className="md:col-span-4 border-none shadow-sm bg-gray-50/50 hover:bg-gray-50 transition-colors rounded-2xl">
                            <CardHeader className="flex flex-row items-center justify-between pb-2">
                                <CardTitle className="text-sm font-medium text-zinc-500">Proyectos Activos</CardTitle>
                        ...
                        <Card className="md:col-span-4 border-none shadow-sm bg-gray-50/50 hover:bg-gray-50 transition-colors rounded-2xl">
                            <CardHeader className="flex flex-row items-center justify-between pb-2">
                                <CardTitle className="text-sm font-medium text-zinc-500">Ingresos Mensuales</CardTitle>
                ...
                {user.role !== "admin" && (
                    <>
                        <Card className="md:col-span-6 border-none shadow-sm bg-gray-50/50 rounded-2xl">
                            <CardHeader>
                                <CardTitle className="text-sm font-medium text-zinc-500">Mis Proyectos</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <div className="text-2xl font-bold text-zinc-900">0 Activos</div>
                            </CardContent>
                        </Card>
                        <Card className="md:col-span-6 border-none shadow-sm bg-gray-50/50 rounded-2xl">
                            <CardHeader>
                                <CardTitle className="text-sm font-medium text-zinc-500">Tareas Pendientes</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <div className="text-2xl font-bold text-zinc-900">Todo al día 🎉</div>
                            </CardContent>
                        </Card>
                    </>
                )}
                ...
                <div className="md:col-span-8 bg-zinc-900 rounded-3xl p-8 text-white relative overflow-hidden group">
                ...
                <Card className="md:col-span-4 border-gray-100 shadow-sm rounded-3xl h-full flex flex-col">
                    <CardHeader>
                        ...
                        <div className="space-y-6">
                            {[1, 2, 3].map((_, i) => (
                                <div key={i} className="flex items-start gap-4 group">
                                    <div className="h-10 w-10 rounded-full bg-gray-100 flex items-center justify-center shrink-0 group-hover:bg-primary/10 transition-colors">
                                        <TrendingUp className="h-5 w-5 text-gray-500 group-hover:text-primary transition-colors" />
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center justify-between mb-1">
                                            <p className="text-sm font-medium text-zinc-900 truncate">Actualización de Sistema</p>
